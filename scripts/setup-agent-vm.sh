...
#      start it yourself after reviewing agent.env, see the note printed
#      at the end)
#
...
echo "=== Setup complete ==="
echo ""
echo "  Before starting: review/edit ${AGENT_DIR}/agent.env"
echo "  (AGENT_IP, MCPSERVER_IP, MCP_SERVER_PORT, OLLAMA_URL, MCP_AUTH_TOKEN)."
echo "  Make sure mcp-server is already running — run setup-mcphost.sh on"
echo "  that host first if you haven't."
echo ""
...
echo "  UI once started: http://$(hostname -I | awk '{print $1}'):8000"
